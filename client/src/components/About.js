      ...
      <div className="card">
        ...
        <div className="card-body">
          <p className="card-text">
            <p className="lead">
              Conta i Ciclisti is a bottom-up project organized by Associazione SalvaiCiclisti Roma
              to count cyclists who cycle through Rome
              every day for any reason: work, leisure or simply go shopping. If
              you want to contribute to fund raising, more info on the project
